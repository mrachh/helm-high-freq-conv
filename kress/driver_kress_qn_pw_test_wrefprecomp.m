...
B = load('data_all_apr18_2022.mat');
ref_sols_all = B.ref_sols_all;
...
save('data_postproc_apr26_2022_circ_only.mat','err_pw','err_qnkqn','errs','gpars0',...
